...
- **Curated to only what IPADIC 4.x LACKS** — probed ~100 candidates from slang research against the base dict; most (やばい/だるい/えぐい/きしょい/うまい/草/推し/めっちゃ/マジ/ガチ …) are already present. The ~22 genuine gaps span i-adjectives (きもい, うざい, エモい, ちゃちい, エロい, グロい), modern nouns (ワンチャン, コスパ, タイパ, リア充, 陰キャ, 陽キャ, ぼっち, ガチ勢), an adverb/interjections (めちゃ, どんまい, やったー, そっか, まじか), and a few contractions (てか, なくちゃ, なきゃ).
- **Contractions are the risky class** (they overlap grammatical forms). Every one passed an OVER-FIRING check — adding it must not change how a sentence tokenizes where its parts should parse normally. Testing rejected several (じゃん mangled じゃんけん; っす broke きっすい). The surviving contractions are pinned by over-firing regressions in `corpus.spec.ts`.
